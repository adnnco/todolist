<x-modal name="task-create-modal" focusable>
    ...
    <form class="p-4 md:p-5" wire:submit.prevent="createTask">
        ...
        <div class="relative z-0 w-full mb-5 group">
            <textarea name="description" wire:model="description" id="task_description"
                      class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
        ...
        <div class="flex z-0 mb-5 group gap-2">
            <div class="relative">
                ...
                <input name="due_date" wire:model="due_date" datepicker datepicker-min-date="{{ date('m/d/Y') }}"
                       datepicker-autohide id="default-datepicker" type="text"
                       class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-md focus:ring-blue-500 focus:border-blue-500 inline-block w-[90px] ps-6 pt-1.5 p-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <button  x-on:click="$dispatch('close')" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">{{ __('Cancel') }}</button>
    </form>
</x-modal>
